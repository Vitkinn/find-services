...
import 'package:tcc_frontend/src/modules/service_requests/data/datasource/remote/service_request_datasource.dart';
...
class ServiceRequestModule extends Module {
  ...
  List<Bind> get binds => [
        // Datasource
        Bind.lazySingleton((i) => ServiceRequestDatasource(restClient: i.get())),
        Bind.lazySingleton((i) => ServiceRequestRepository(datasource: i.get())),
        Bind.lazySingleton((i) => RequestServiceUsecase(repository: i.get())),
        Bind.lazySingleton((i) => RequestServiceController(requestServiceUsecase: i.get())),
      ];
