...
import 'package:findservices/src/modules/shared/controllers/impl/image_picker_controller.dart';
...
import 'package:findservices/src/modules/shared/widgets/terms_responsibility.dart';

class SharedModule extends Module {
  @override
  List<Bind> get binds => [
        Bind.singleton<IAuthController>((i) => AuthController(), export: true),
        Bind.lazySingleton<IImagePickerController>(
